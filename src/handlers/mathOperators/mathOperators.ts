...
const sin : TOneArgOperations = (degrees : number) => Number(Math.sin(degrees * Math.PI/180).toFixed(1));
const cos : TOneArgOperations = (degrees : number) => Number(Math.cos(degrees * Math.PI/180).toFixed(1));
const tan : TOneArgOperations = (degrees : number) => Number(Math.tan(degrees * Math.PI/180).toFixed(1));
